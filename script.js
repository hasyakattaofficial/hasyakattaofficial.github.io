...
 var h = d.getHours(); 
 ...
 10>t?t="0"+t:t=t;
 12>h?time=h+":"+t+" am":time=(h-12)+":"+t+" pm";
 var hello=["HELLO","HI", "HELLO SA","HEY THERE","HEY","HI DUDE","HI SA","HELLO Hasya Katta AI","HI Serhat","HLO","MRB","H","HI THERE"];
 var coin=["FLIP A COIN"];
 var gm=["GM","GOOD MORNING","GOOD MORNING Hasya Katta AI", "GOOD MORNING SA","GOOD M","G MORNING"];
  
var goo =["WHAT IS GOOGLE"];
 var bad=["BAD","NOT BAD","USELESS","NOT WORKING","NOT GOOD"];
 var ge=["GOOD EVNG","GOOD EVENING","GOOD EVENING Hasya Katta AI","GOOD EVENING DC"];
 ...
 var good=["I'M GOOD","I'M FINE","I AMFINE","I AM FINE AND YOU", "I'M FINE AND YOU", "I'M FINE U", "I AM FINE","I'M FINE AND HOW ARE YOU", "MEE TOO", "FINE","FINE:)","FINE :)","I AM FINE WHAT ABOUT YOU", "MARVELOUS","AWESOME","FINE☺️","GREAT"];
 var yes=["REALLY",""]
 ...
 var wrud=["WHAT R U DOING?","WHAT ARE YOU DOING?", "WHAT'S UP", "WHAT'S UP BUDDY","WHAT ARE YOU DOING"];
  ...
  var smitshetye=["SMIT","SMIT SHETYE","SHETYE"];
...
isInArray(wru, lastmsg)==true?(smsg="I am Hasya Katta AI made by Smit Shetye", k=smsg):
...
isInArray(smitshetye, lastmsg)==true?(smsg="Shape the reality", k=smsg):
isInArray(qu, lastmsg)==true?(k="I don't know ", smsg=k+"😕"):
isInArray(make, lastmsg)==true?(k="Smit Shetye", smsg=k+"😕"):
isInArray(st, lastmsg)==true?(smsg="No, You Shut up", k=smsg):
...
(smsg="Sorry, I have no answer for that. If you say so I can search for you. To search, <br> type <q><b> Search Your keyword </b></q> for example type : <b>Search Hasya Katta Official</b>",k="Sorry, I have no answer for that.   If you say, so I can search for you. To search,type,Search Your keyword,for example, type, Search sololearn, ");
